...
### Wrap your app with the Layout component

Some components can be standalone, but to make sure that components work
correctly, we recommend you to wrap your entire app with the [Layout](/core/Layout) component.
This allows the components styling be consistent across your entire application
...
Check of [Layout Docs](/core/Layout) for available options
