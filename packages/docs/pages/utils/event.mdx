...
<Preview>
  <CodeHighlight>
    ```ts import {CustomEventHandler} from '@vue-material/core' import{' '}
    {CustomEventHandler} from '@vue-material/core/utils' import{' '}
    {CustomEventHandler} from '@vue-material/core/utils/event' ```
  </CodeHighlight>
</Preview>
...
> <Preview>
>   <CodeHighlight>
>     ```ts // Don't do this class MyClass extends CustomEventHandler,
>     HTMLElement{' '}
>     {
>       // ...my code
>     }
...
>   </CodeHighlight>
>   <CodeHighlight>
>     ```ts // Do this if you're creating a custom html element class
